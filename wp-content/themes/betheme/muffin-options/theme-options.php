	...
	function mfn_opts_setup(){
		...
		$sections['shop-single'] = array(
			...
			'fields'	=> array(
				...
				array(
					'id' => 'shop-mobile-review-avatar-hide',
					'type' => 'switch',
					'title' => __('Reviews avatar on mobile', 'mfn-opts'),
					'options' => array(
						'1' => __('Hide', 'mfn-opts'),
						'0'	 => __('Show', 'mfn-opts'),
					),
		...
		$sections['pages-404'] = array(
			...
			'fields' => array(
				...
				array(
					'id' => 'error404-page',
					'attr_id' => 'error404-page',
					'type' => 'select',
					'title' => __('Custom page', 'mfn-opts'),
					'desc' => __('Leave this field <b>blank</b> if you want to use default page.<br /><br /><b>Notice: </b>Page Options are disabled. Plugins like <i>WPBakery Page Builder</i>, <i>Elementor</i> & <i>Gravity Forms</i> do <b>not</b> work on Custom page.', 'mfn-opts'),
					'options' => mfna_pages(),
					'js_options' => 'pages',
				),
				...
				array(
					'id' => 'error404-header',
					'condition' => array( 'id' => 'error404-page', 'opt' => 'isnt', 'val' => '0' ), // is or isnt and value
					'type' => 'switch',
					'title' => __('Header', 'mfn-opts'),
					'options' => array(
						'0' => __('Hide', 'mfn-opts'),
		...
		$sections['colors-shortcodes'] = array(
			...
			'fields' => array(
				...
				array(
					'id' => 'color-table-th',
					'type' => 'color',
					'title' => __('Table TH color', 'mfn-opts'),
					'std' => '#444444',
					'class' => 'to-inline-style',
					'data_attr' => 'data-csspath="table th" data-responsive="desktop" data-style="color" data-unit=""',
				),

				array(
					'id' => 'color-tab',
					'type' => 'color',
					'title' => __('Toggle Accordion Tabs Title color', 'mfn-opts'),
					'std' => '#444444',
					'class' => 'to-inline-style',
					'data_attr' => 'data-csspath=".ui-tabs .ui-tabs-nav li a,.accordion .question > .title,.faq .question > .title, .fake-tabs > ul li a" data-responsive="desktop" data-style="color" data-unit=""',
				),

				array(
					'id' => 'color-tab-title',
					'type' => 'color',
					'title' => __('Toggle Accordion Tabs Active color', 'mfn-opts'),
					'std' => '#0089F7',
					'class' => 'to-inline-style',
